...
[Введение](#введение) [3](#введение)

[Актуальность](#актуальность) [4](#актуальность)

[Новизна и анализ рынка](#новизна-и-анализ-рынка)
[5](#новизна-и-анализ-рынка)

[Команда проекта](#команда-проекта) [7](#команда-проекта)

[Цели и задачи проекта](#цели-и-задачи-проекта)
[8](#цели-и-задачи-проекта)

> [Проблема](#проблема) 8
>
> [Цель проекта](#цель-проекта) [8](#цель-проекта)
>
> [Задачи проекта](#задачи-проекта) [8](#задачи-проекта)

[План проекта](#план-проекта) [9](#план-проекта)

[Ресурсы](#ресурсы) [9](#ресурсы)

[Проектирование](#проектирование) [10](#проектирование)

> [Описание работы приложения](#описание-работы-приложения)
> [10](#описание-работы-приложения)
>
> [Разработка оформления сайта](#разработка-оформления-сайта)
> [11](#разработка-оформления-сайта)
>
> [Разработка расширения для Google
> Chrome](#разработка-расширения-для-google-chrome)
> [11](#разработка-расширения-для-google-chrome)
>
> [Серверная часть](#серверная-часть) [12](#серверная-часть)
>
> [Back End сайта](#back-end-сайта) [20](#back-end-сайта)

[Результат, выводы и пути развития:](#результат-выводы-и-пути-развития)
[22](#результат-выводы-и-пути-развития)

[Пример работы расширения](#пример-работы-расширения)
[23](#пример-работы-расширения)

[Список источников и использованной
литературы](#список-источников-и-использованной-литературы)
[23](#список-источников-и-использованной-литературы)

**[Приложения](#приложения)** [25](#приложения)
...
+------------+------------+----------------+--------------------------+
| **ФИО**    | **Д        | **Функция в    | **Задачи в проекте**     |
|            | олжность** | проекте**      |                          |
+------------+------------+----------------+--------------------------+
| Ж          | Учитель    | Научный        | 1\. Организация работы   |
| емчужников | и          | руководитель   | проектной команды.       |
| Дмитрий    | нформатики |                |                          |
| Г          |            |                | 2\. Обеспечение          |
| ригорьевич |            |                | ресурсами.               |
+------------+------------+----------------+--------------------------+
| Юнда       | ГБОУ Школа | Веб-дизайнер,  | 1.  Разработка и дизайн  |
| Степан     | №1535, 10  | специалист по  |     расширения и сайта   |
|            | «В»        | верстке,       |                          |
|            |            | размещению     | 2.  Помощь в обучении    |
|            |            | сайтов         |     нейронной сети       |
|            |            |                |                          |
|            |            |                | 3.  Разработка бекенда   |
+------------+------------+----------------+--------------------------+
| Щербаков   | ГБОУ Школа | Data science,  | 1.  Обучение нейронной   |
| Алексей    | №1535, 10  | flask          |     сети.                |
|            | «В»        | специалист     |                          |
...
Таблица 2. Календарный план проекта
  ...
  ------- ------------------------------ ----------------- -----------------
  **№     **Название этапа**             **Сроки           **Участники**
  п/п**                                  реализации**      

  1       Подготовка, планирование       1.09 -- 15.10     А, С, НР

  2       Разработка                     15.10 -- 27.01    А, С

  3       Подведение итогов, развитие    29.01 -- 01.03    А, С, НР
  ------- ------------------------------ ----------------- -----------------
